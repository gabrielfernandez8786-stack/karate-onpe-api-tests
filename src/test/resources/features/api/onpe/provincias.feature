Feature: Consulta de provincias - ONPE
  ...
  Scenario: Obtener provincias de Lambayeque
    Given path 'ubigeos/provincias'
    And param idEleccion = 10
    And param idAmbitoGeografico = 1
    And param ubigeoDepartamento = 140000
    When method GET
    Then status 200
    And print 'Provincias de Lambayeque:', response

  Scenario: Obtener provincias de Lima
    Given path 'ubigeos/provincias'
    And param idEleccion = 10
    And param idAmbitoGeografico = 1
    And param ubigeoDepartamento = 150000
    When method GET
    Then status 200
    And print 'Provincias de Lima:', response